...
> 文档状态：历史研究 / Explanation。本文保留产品形态和竞品研究过程，不定义当前产品范围。
> 其中移动端、静态原型和旧导航结论已被
> [`前端统一设计规范`](../page-design/01_前端统一设计规范.md)取代；
> 当前版本仅支持 1024 px 及以上桌面端。
...
| 历史设计输入 | 页面功能清单及本文低保真原型属于早期规划材料 | 用于解释设计来源；不得作为已交付能力、现行信息架构或可复用交易组件 |
...
页面级功能与低保真布局已经按同一对象和流程落地，详见
[前端设计文档索引](../page-design/00_前端设计文档索引.md)；历史布局推导见
[页面布局辩论与裁决](frontend/页面布局辩论与裁决.md)；开源项目能力映射、采用判断和
许可证边界见 [开源项目与页面形态参考](frontend/开源项目参考与页面补充.md)。
