...
```json
{
  ...
  "error": {
    ...
    "message": "当前无有效授权书",
    "details": { "mandate_status": "draft", "required_action": "activate_mandate" }
  }
}
```
...
```json
{
  ...
  "region": "CN",
  "goals": [
    { "name": "退休储备", "target_amount": 2000000, "target_date": "2055-01-01", "priority": 1 },
    { "name": "子女教育", "target_amount": 500000, "target_date": "2040-09-01", "priority": 2 }
  ],
  "financial_constraints": {
    "investable_amount": 500000,
    "emergency_fund": 100000,
    "near_term_cash_needs": 50000,
    "major_liabilities": { "mortgage_remaining": 1200000, "monthly_payment": 8000 }
  },
  "stated_risk": {
    "loss_tolerance": 0.15,
  ...
  "restrictions": {
    ...
    "concentration_limits": { "max_single_asset": 0.10 },
    "esg_preference": null,
...
```json
{
  ...
  "action": "activate",
  "goal_priorities": [
    { "goal_name": "退休储备", "priority_rank": 1 }
  ],
  "risk_budget": {
    "max_drawdown": 0.20,
    "volatility_cap": 0.18,
...
```json
{
  ...
  "data": {
    ...
    "version": 1,
    "positions": [
      { "symbol": "510300.SH", "name": "沪深300ETF", "quantity": 1000, "avg_cost": 4.20, "market_value": 4350, "resolved": true }
    ],
    "unresolved_positions": [
      { "raw_name": "华夏回报混合A", "raw_symbol": null, "quantity": 5000, "estimated_value": 6200, "match_candidates": [{ "symbol": "002001.OF", "name": "华夏回报混合A", "confidence": 0.95 }] }
    ],
...
```json
{
  ...
  "data": {
    ...
    "status": "in_progress",
    "instruments": [
      { "instrument_id": "uuid1", "symbol": "510300.SH", "status": "in_progress" }
    ],
...
```json
{
  ...
  "data": {
    ...
    "version": 1,
    "status": "candidate",
    "global_allocation": { "cash_ratio": 0.10, "equity_ratio": 0.60, "bond_ratio": 0.30 },
    "market_allocation": { "a_shares": { "weight": 0.40 }, "us_stocks": { "weight": 0.20 } },
    "risk_scenarios": [
      { "scenario_name": "基准", "expected_return": 0.08, "expected_volatility": 0.12, "max_drawdown": -0.15, "probability": 0.50 },
...
```json
{
  ...
  "data": {
    ...
    "constructible": true,
    "target_weights": [
      { "instrument_id": "uuid", "symbol": "510300.SH", "weight": 0.25, "target_value": 140000, "current_weight": 0.20, "delta": 0.05 },
      { "instrument_id": "uuid", "symbol": "510500.SH", "weight": 0.15, "target_value": 84000, "current_weight": 0.10, "delta": 0.05 },
      { "instrument_id": "uuid", "symbol": "511010.SH", "weight": 0.30, "target_value": 168000, "current_weight": 0.35, "delta": -0.05 }
    ],
    "constraint_report": {
      "passed": [
        { "rule": "max_single_asset", "value": 0.25, "limit": 0.10, "note": "需调仓后满足" }
      ],
      "failed": [],
      "warnings": [
        { "rule": "sector_concentration", "value": 0.28, "limit": 0.30, "note": "接近上限" }
      ]
    },
    "risk_metrics": {
    ...
    "rebalance_plan": [
      { "instrument_id": "uuid", "symbol": "510300.SH", "action": "buy", "quantity": 6500, "estimated_value": 28000, "priority": 1, "reason": "增加沪深300配置至目标权重" }
    ],
...
```json
{
  ...
  "data": {
    ...
    "quantity": 6500,
    "status": "approved",
    "risk_check_1": { "passed": true, "checks": [{ "rule": "asset_scope", "passed": true }, { "rule": "concentration", "passed": true }] },
    "risk_check_2": { "passed": true, "checks": [{ "rule": "mandate_active", "passed": true }, { "rule": "autonomy_level", "passed": true }, { "rule": "no_cooldown", "passed": true }] },
    "mandate_version": 1,
...
```json
{
  ...
  "data": {
    ...
    "order_intent_id": "uuid",
    "status": "submitted",
    "risk_check_3": { "passed": true, "checks": [{ "rule": "cash_sufficient", "passed": true }, { "rule": "price_protection", "passed": true }, { "rule": "market_available", "passed": true }] }
  }
}
```
