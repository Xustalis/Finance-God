"""火山引擎 (Volcengine Seed) LLM 提供者 - OpenAI 兼容的 /chat/completions 接口"""
...
class VolcengineLLMProvider(LLMProvider):
    """火山引擎 Seed API 提供者（OpenAI 兼容）"""
    ...
    def __init__(
        ...
        self.base_url = base_url or settings.volcengine_base_url
        self.model = model or settings.volcengine_model
...
def register():
    ...
    llm_provider_registry.register("volcengine", VolcengineLLMProvider)
